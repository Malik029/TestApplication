...
public class OrangeHRM_AddEmployee extends LogInTest {
	...
	public void AddEmployeeFirstNameTestData1() throws InterruptedException, IOException {
		...
		for (int rowIndex1 = 1; rowIndex1 <= 9; rowIndex1++) {
			...
			Thread.sleep(1000);
			 // Runtime.getRuntime().exec(System.getProperty("user.dir")+"C:\\Users\\DELL\\eclipse-workspace\\oRGHRM1_DDT\\UploadPhoto\\FileUpload1.exe");
			java.lang.Runtime.getRuntime().exec("C:\\\\Users\\\\DELL\\\\eclipse-workspace\\\\oRGHRM1_DDT\\\\UploadPhoto\\\\FileUpload1.exe");  
